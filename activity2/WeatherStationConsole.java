...
public class WeatherStationConsole extends Frame implements Runnable {

    /*
     * When the application runs, the user will choose which UI they prefer
